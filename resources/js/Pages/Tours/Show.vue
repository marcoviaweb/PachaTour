              ...
              <div class="flex flex-col md:flex-row md:items-end md:justify-between">
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-2 mb-2">
                    ...
                    <span v-if="tour.is_featured" class="bg-pacha-400 text-pacha-900 px-3 py-1 text-sm font-semibold rounded-full">
                      Destacado
                    </span>
                  </div>
                  ...
                  <div class="flex flex-wrap items-center space-x-6 mt-4 text-sm">
                    <div v-if="tour.rating" class="flex items-center">
                      <svg class="w-4 h-4 text-pacha-400 fill-current mr-1" viewBox="0 0 20 20">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section v-if="tour.included_services" class="bg-white rounded-lg shadow-md p-6">
              <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                <svg class="w-5 h-5 text-pacha-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <ul class="space-y-2">
                ...
                >
                  <svg class="w-4 h-4 text-pacha-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  {{ service }}
                </li>
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="flex items-center ml-3">
                      <svg 
                        ...
                        :key="star"
                        class="w-4 h-4"
                        :class="star <= review.rating ? 'text-pacha-400 fill-current' : 'text-gray-300'"
                        viewBox="0 0 20 20"
                      >
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                      </svg>
...
const getTypeBadgeClass = (type) => {
  const classes = {
    ...
    'nature': 'bg-pacha-100 text-pacha-800',
