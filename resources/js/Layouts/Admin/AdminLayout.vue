    ...
    <nav class="bg-white shadow-lg border-b border-gray-200">
        ...
        <div class="flex justify-between h-16">
          ...
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              ...
              <NavLink href="/admin/departments" :active="$page.url.startsWith('/admin/departments')">
                Departamentos
              </NavLink>
              <NavLink href="/admin/attractions" :active="$page.url.startsWith('/admin/attractions')">
                Atractivos
              </NavLink>
            </div>
          </div>
      ...
      <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <ResponsiveNavLink href="/admin/departments" :active="$page.url.startsWith('/admin/departments')">
            Departamentos
          </ResponsiveNavLink>
          <ResponsiveNavLink href="/admin/attractions" :active="$page.url.startsWith('/admin/attractions')">
            Atractivos
          </ResponsiveNavLink>
        </div>
