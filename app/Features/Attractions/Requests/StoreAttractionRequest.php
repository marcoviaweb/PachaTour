...
class StoreAttractionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'required|string|in:' . implode(',', array_keys(Attraction::TYPES)),
            'latitude' => 'required|numeric|between:-90,90',
            'longitude' => 'required|numeric|between:-180,180',
            'address' => 'nullable|string|max:200',
            'city' => 'required|string|min:2|max:100|regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\-]+$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'name.required' => 'El nombre del atractivo es obligatorio.',
            ...
            'type.required' => 'El tipo de atractivo es obligatorio.',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            // Validate that coordinates are within Bolivia's approximate bounds
            $lat = $this->latitude;
            $lng = $this->longitude;
            ...
            // Validate opening hours consistency
